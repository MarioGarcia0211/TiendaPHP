                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-fixed table-striped">
                            ...
                            <tbody class="text-center">
                                <?php
                                //Paginacion
                                $sql_registe = mysqli_query($conection, "SELECT COUNT(*) AS totalUsuarios FROM log_login WHERE (fecha LIKE '%$busqueda%') ");
                                ...
                                $query = mysqli_query($conection, "SELECT * FROM log_login WHERE (fecha LIKE '%$busqueda%') ORDER BY `log_login`.`idLogLogin` DESC LIMIT $desde,$por_pagina");
