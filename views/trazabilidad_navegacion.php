                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-fixed table-striped">
                            ...
                            <tbody class="text-center">
                                <?php
                                //Paginacion
                                $sql_registe = mysqli_query($conection, "SELECT COUNT(*) AS totalUsuarios FROM log_navegacion");
                                ...
                                $query = mysqli_query($conection, "SELECT * FROM log_navegacion ORDER BY `log_navegacion`.`idLogNavegacion` DESC LIMIT $desde,$por_pagina");
