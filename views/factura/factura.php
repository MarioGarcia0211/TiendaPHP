	...
	<div id="page_pdf">
			...
			<tr>
				...
				<td class="info_factura">
					<div class="round">
						...
						<p>No. Factura: <strong><?php echo $factura['idFactura']; ?></strong></p>
				...
				<td class="info_cliente">
					<div class="round">
						...
						<table class="datos_cliente">
							<tr>
								<td><label>Número documento:</label>
									<p><?php echo $factura['numeroDocumento']; ?></p>
								</td>
		...
		<table id="factura_detalle">
			...
			<tbody id="detalle_productos">
				...
				$tl_sniva 	= $subtotal;
				$descontar = $tl_sniva * ($descuento / 100);
                $total = $tl_sniva - $descontar;
				?>
			</tbody>
			<tfoot id="detalle_totales">
				...
				<tr>
					...
					<td class="textright"><span><?php echo $descuento.'%'; ?></span></td>
				</tr>
				<tr>
