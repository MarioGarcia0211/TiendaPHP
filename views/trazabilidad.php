...
<head>
    ...
    <title>Trazabilidad login</title>
...
<body>
    ...
    <div class="contenedor">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="trazabilidad.php">Trazabilidad del login</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="trazabilidad_navegacion.php">Trazabilidad de navegación</a>
            </li>
        ...
        <div class="container-fluid">
            <h1 >Trazabilidad del login</h1>
            <form class="d-flex" role="search" action="buscar_trazabilidad_login.php" method="get">
                <input class="form-control me-2" type="date" name="busqueda" id="busqueda" placeholder="Buscar" aria-label="Search">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-fixed table-striped">
                            ...
                            <tbody class="text-center">
                                <?php
                                //Paginacion
                                $sql_registe = mysqli_query($conection, "SELECT COUNT(*) AS totalUsuarios FROM log_login");
                                ...
                                $query = mysqli_query($conection, "SELECT * FROM log_login ORDER BY `log_login`.`idLogLogin` DESC LIMIT $desde,$por_pagina");
